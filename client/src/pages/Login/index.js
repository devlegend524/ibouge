...
import { loginUserWithEmail, activeUser, toggleRememberMe } from '../../actions/authActions';
        ...
        <div className="container-fluid containerWidth">
          <div className="row">
            ...
            <div className="col-md-4 col-sm-4 col-12 text-center">
              ...
              <h4 className="login-greeting">Welcome! Log in to your account</h4>
              <div className="login-box">
                ...
                <form name="loginForm" onSubmit={formik.handleSubmit}>
                  <InputControl placeholder="Email" name="email" nid="exampleInputEmail3" handle={formik} />
                  <InputControl placeholder="Password" name="password" nid="exampleInputPassword3" type="password" handle={formik} />
            ...
            <div className="col-md-4 col-sm-4 col-12 text-right">
              <span className="login-signup">Don't have an account?</span><Link to="/register"><button type="button"
