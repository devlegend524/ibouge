...
const CountryView = () =>  {
  ...
  useEffect(() => {
    dispatch(setTitle('Map OSM'))
  }, []);

  const key = sessionStorage.countryISOKey;

  const mapPath = 'https://code.highcharts.com/mapdata/countries/' + key + '/' + key + '-all.geo.json';
      ...
      <>
        ...
        <div className="row">
          <div className="col-md-6 col-sm-6 col-12">
            ...
            <h1 className="mt-120 text-center">Country : <span className="countryName">{ mapTitle }</span></h1>
              <MapChart 
                options={mapOptions} 
